  ...
  <div class="main-content">
    <div style="width: 75%; margin: 10px auto;">
      ...
      <!--      <div style="font-weight: 700; font-size: 16px; padding: 15px 30px; border-bottom: 1px solid #eeeeee">评论信息</div>-->
        ...
        <el-dialog title="请选择时间" :visible.sync="fromVisible" width="30%" :close-on-click-modal="false" destroy-on-close>
          <el-form label-width="100px" style="padding-right: 50px">
            <el-form-item prop="inTime" label="入住时间">
              <el-date-picker v-model="inTime" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" style="width: 80%"></el-date-picker>
            </el-form-item>
            <el-form-item prop="outTime" label="离开时间">
              <el-date-picker v-model="outTime" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" style="width: 80%"></el-date-picker>
            </el-form-item>
          </el-form>
